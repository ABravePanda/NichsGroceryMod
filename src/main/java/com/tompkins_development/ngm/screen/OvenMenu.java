...
import com.tompkins_development.ngm.screen.slot.ModResultSlot;
...
public class OvenMenu extends AbstractContainerMenu {
    ...
    public OvenMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 51, 45));
            this.addSlot(new SlotItemHandler(handler, 1, 51, 16));
            this.addSlot(new ModResultSlot(handler, 2, 51, 45));
        });
